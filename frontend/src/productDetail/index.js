            ...
            <div className="content-left">
              ...
              <div className="content-left-order">
                ...
                <div className="order-btn">
                  ...
                  <button className="order-btn-buy-now">Mua ngay</button>
                </div>
                ...
                <div className="order-discount">
                  ...
                  <ul>
                    <li>Giảm giá 500,000đ khi tham gia thu cũ đổi mới</li>
                    <li>Giảm giá khi mua tại cửa hàng</li>
                    <li>Cáp sạc Lightning iPhone Zin cao cấp: 120.000đ</li>
                    <li>
                      Mua Đồng hồ thời trang giảm 40% (không kèm khuyến mãi
                      khác)
                    </li>
                  </ul>
                </div>
            ...
            <div className="content-specification">
              ...
              {product.specification && (
                <ul className="specification-list">
                  <li>
                    <p>Màn hình</p>
                    <span>{product["specification"]["screen"]}</span>
                  </li>
                  <li>
                    <p>Hệ điều hành</p>
                    <span>{product["specification"]["os"]}</span>
                  </li>
                  <li>
                    <p>Camera trước</p>
                    <span>{product["specification"]["frontCamera"]}</span>
                  </li>
                  <li>
                    <p>Camera sau</p>
                    <span>{product["specification"]["rearCamera"]}</span>
                  </li>
                  <li>
                    <p>Chip</p>
                    <span>{product["specification"]["chip"]}</span>
                  </li>
                  <li>
                    <p>RAM</p>
                    <span>{product["specification"]["RAM"]}</span>
                  </li>
                  <li>
                    <p>Bộ nhớ trong</p>
                    <span>{product["specification"]["ROM"]}</span>
                  </li>
                  <li>
                    <p>SIM</p>
                    <span>{product["specification"]["SIM"]}</span>
                  </li>
                  <li>
                    <p>Pin</p>
                    <span>{product["specification"]["pin"]}</span>
                  </li>
                </ul>
              )}
            </div>
